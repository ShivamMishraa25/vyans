...
$pageTitle = 'ताज़ा समाचार';
$perPage = 10;
$page = max(1, (int)($_GET['page'] ?? 1));
$offset = ($page - 1) * $perPage;

// total
$stmtC = $mysqli->prepare('SELECT COUNT(*) AS c FROM posts WHERE isNews = 1');
$stmtC->execute();
...
<section class="max-w-6xl mx-auto px-4 py-8">
	<h1 class="text-2xl font-bold mb-4 text-blue-800">ताज़ा समाचार</h1>
	<?php if ($rows): ?>
	...
	<?php else: ?>
		<p class="text-sm text-gray-600">कोई ताज़ा समाचार उपलब्ध नहीं है।</p>
	<?php endif; ?>
